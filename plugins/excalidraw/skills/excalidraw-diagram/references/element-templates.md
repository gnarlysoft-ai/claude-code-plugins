...
```json
{
  ...
  "x": 94, "y": 94,
  "width": 12, "height": 12,
  "strokeColor": "<marker dot stroke from palette>",
  "backgroundColor": "<marker dot fill from palette>",
  "fillStyle": "solid",
  "strokeWidth": 1,
  "strokeStyle": "solid",
  "roughness": 0,
...
```json
{
  ...
  "strokeColor": "<text color — use 'on dark fills' from palette for most shapes>",
  "backgroundColor": "transparent",
  "fillStyle": "solid",
  "strokeWidth": 1,
  "strokeStyle": "solid",
